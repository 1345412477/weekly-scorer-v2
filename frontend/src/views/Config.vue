...
5. 加班分（预留，当前版本不计算）：后续若提供加班时长，将在 100 分基础上额外加分，本轮输出 score 仍为 0-100。

## 输出要求
请严格以 JSON 格式返回，不要额外文字：
{"score": 总分(0-100), "full_attendance": true/false, "late_count": 迟到次数, "missing_count": 缺卡次数, "comment": "简短点评（说明扣分原因）"}`
